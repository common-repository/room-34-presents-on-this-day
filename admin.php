...
add_action('admin_menu', 'r34otd_admin_menu', 10);
	...
	<div class="wrap r34otd">
		...
		<div class="metabox-holder columns-2">
			...
			<div class="column-2">
				...
				<p style="text-align: center;"><small>On This Day (by Room 34) v. <?php echo wp_kses_post($plugin_data['Version']); ?></small></p>
